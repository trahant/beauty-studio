...
export const PAGES: PageMeta[] = [
  {
    path: "/",
    title: "Beauty Secrets Studio | Facials, Threading, Waxing & Henna in West Los Angeles",
    description:
      "Expert facials, threading, waxing, and henna tattoos in West Los Angeles. Walk-ins welcome. Specialists only. Call (310) 306-3191.",
  },
  {
    path: "/facials",
  ...
  {
    path: "/facials/skincare-treatments",
  ...
  {
    path: "/facials/anti-aging-solutions",
  ...
  {
    path: "/lashes/lash-extension-removal",
